...
When you make a quantum move, the square root of iswap is applied. The goal is that if you apply the gate twice, it ends up in a regular move. The iswap has been chosen for demonstrating interference.
